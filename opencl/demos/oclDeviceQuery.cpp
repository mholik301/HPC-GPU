...
int main(int argc, char** argv) 
{
    ...
    shrLog("\nSystem Info: \n\n");
        ...
        //USER EDIT (this function is deperecated and works wrong (say I have Win Vista/7), but this pragma is a workaround for compiling it)
        //src: https://stackoverflow.com/questions/22303824/warning-c4996-getversionexw-was-declared-deprecated/27323983
